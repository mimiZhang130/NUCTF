  ...
  return (
    <div>
        ...
        <div className="container">
            ...
            <h1>Find Us</h1>
            <div className="bodyText">
                <Socials icon="/assets/socials/email.svg" text="Email Us: ctfteam@u.northwestern.edu" link="mailto:ctfteam@u.northwestern.edu"/>
                <Socials icon="/assets/socials/instagram.svg" text="Instagram: nu_ctf" link="https://www.instagram.com/nu_ctf/"/>
                <Socials icon="/assets/socials/github.svg" text="Github:" link="/"/>
                <Socials icon="/assets/socials/ctf.svg" text="CTFTime:" link="/"/>
                <Socials icon="/assets/socials/wildcat.svg" text="Wildcat Connection: CTF Team" link="https://northwestern.campuslabs.com/engage/organization/ctfteam"/>
            </div>
        </div>
